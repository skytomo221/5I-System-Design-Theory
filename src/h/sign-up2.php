...
$conn = pg_connect("host=localhost port=5432 dbname=postgres user=postgres password=5ig4pass");
//$conn = pg_connect("host=dougom29.kagoshima-ct.ac.jp dbname=group4 user=group4 password=5ig4pass");
if (!$conn) {
    die('接続できませんでした');
}
echo '接続に成功しました';
